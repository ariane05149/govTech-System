...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            ServiceApplication app = appManager.createApplication(citizen, chosenService);
            System.out.println("Application created with status: Pending");
            System.out.println("Service fee: " + chosenService.getServiceFee());
            System.out.print("Enter payment Amount: ");
            double amount = input.nextDouble();
            try {
                app.makePayment(amount);
